...
get_comments calls os._exit(1) after get_issue has already checkpointed, so
the process dies mid-investigation. Comment out that line before the second
run to let Dapr resume the workflow from its last checkpoint and complete.
"""
import os
